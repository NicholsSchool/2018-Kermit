...
public class Constants
{
  ...
  public static final double 
    ...
    ELBOW_RAISE_SPD_BELOW_BAR = 0.5,
  	...
  	SHOULDER_RAISE_SPD_ABOVE_BAR = 0.5,
  	...
  	//============CHANGE THESE============
  	ELBOW_RAISE_SPD_BELOW_BAR_CUBE = 0.5,
  	SHOULDER_RAISE_SPD_BELOW_BAR_CUBE = 0.7,
  	ELBOW_RAISE_SPD_ABOVE_BAR_CUBE = 0.6,
  	SHOULDER_RAISE_SPD_ABOVE_BAR_CUBE = 0.5,
  
  	ELBOW_LOWER_SPD_BELOW_BAR_CUBE = -0.3,
	SHOULDER_LOWER_SPD_BELOW_BAR_CUBE = 0.07,
	ELBOW_LOWER_SPD_ABOVE_BAR_CUBE = -0.1,
	SHOULDER_LOWER_SPD_ABOVE_BAR_CUBE = -0.15;

  // encoder values for the arm
  public static final int  
  	SHOULDER_EXTENDED = 160000, //163, 164, 174, 179, 184,    **165
