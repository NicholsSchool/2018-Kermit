...
public class Constants
{
  ...
  public static final double 
    ...
    ELBOW_RAISE_SPD_BELOW_BAR = 0.5,
  	SHOULDER_RAISE_SPD_BELOW_BAR = 0.8,
  	...
  	SHOULDER_RAISE_SPD_BELOW_BAR_CUBE = 1.0,
  	ELBOW_RAISE_SPD_ABOVE_BAR_CUBE = 0.9,
  	SHOULDER_RAISE_SPD_ABOVE_BAR_CUBE = 0.8,
  
  	ELBOW_LOWER_SPD_BELOW_BAR_CUBE = -0.2,
